                ...
                <div style={S.card} className="fade-up">
                    ...
                    <form onSubmit={handleLogin} style={S.form}>
                        ...
                        <button
                            ...
                            style={{ width: '100%', padding: '15px', fontSize: 16, marginTop: 4 }}
                            id="login-submit"
                        >
                            {loading ? (
...
const S: Record<string, React.CSSProperties> = {
    ...
    blob2: {
        position: 'fixed', bottom: -150, right: 200,
    ...
    card: {
        ...
        boxShadow: '0 30px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(108,99,255,0.1)',
    },
